...
<b>이름</b>
<input type="text" name="mem_name" placeholder="Enter name" maxLength="5" required>
<b>닉네임</b>
...
<b>나이</b>
<input type="text" name="mem_birth" maxLength="2" placeholder="Enter birth" required>
<b>주소</b>
...
<button type="reset" class="cancelbtn">다시</button>
</div>
